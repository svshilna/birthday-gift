...
export default function Message() {
  ...
  return (
    <div style={styles.container}>
      ...
      <p>
        There’s something you’ve mentioned so many times…<br />
        A little dream of yours that kept getting postponed for one reason or another.<br />
        This year, I thought it’s finally time to make it happen!<br /><br />
        But I didn’t want to choose it on my own —<br />
